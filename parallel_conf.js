...
let fileDownloadDirectory = path.resolve(__dirname + '/../common/rs-test1/downloads/');
    ...
    multiCapabilities: [
        {
            ...
            'browserName': 'chrome',
            name: 'CAPABILITY_1',
            logName: 'Log_Parallel_Chrome_1',
            'chromeOptions': {
                prefs: {
                    download: {
                        'prompt_for_download': false,
                        'directory_upgrade': true,
                        'default_directory': fileDownloadDirectory
                    }
                },
